...
\newcommand{\ftfzero}{2}    % frequência de x(t) após o filtro anti-aliasing [Hz]
\newcommand{\ftfs}{7}       % frequência de amostragem f_s [Hz]
\newcommand{\ftduty}{0.5}   % razão tau/T_s (0 < duty <= 1)
\newcommand{\fttmax}{1.5}   % duração exibida [s] (3 períodos de 2 Hz)
...
% ============================================================================
\newcommand{\ftfmax}{25}    % faixa de frequência exibida: -fmax a fmax [Hz]
...
% Cores das duas etapas nas demonstrações
\newcommand{\ftamos}[1]{{\color{ftazul}#1}}             % etapa 1: amostragem ideal
\newcommand{\ftret}[1]{{\color{ftlaranja!90!black}#1}}  % etapa 2: retenção (pulso h)

\pgfplotsset{
  ftfreqaxis/.style={
    ftaxis,
    xmin=-\ftfmax, xmax=\ftfmax, ymin=0, ymax=0.68,
    xtick={-14,0,14}, minor xtick={-21,-7,7,21},
    ytick={0,0.25,0.5},
...
%\input{topicos/intro}
%\input{topicos/teoric}
\input{topicos/natural}
%\input{topicos/flattop}
%\input{topicos/metodos}

\begin{frame}[allowframebreaks]{Referências}
	
	% Define o estilo visual da bibliografia para ABNT (Autor, Ano)
	\bibliographystyle{abntex2-alf} 
	
	% Chama o seu arquivo .bib
