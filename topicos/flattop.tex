...
% ============================================================================
\begin{frame}{Método Topo-Plano}{Representação Gráfica no Domínio do Tempo}
\centering
\begin{tikzpicture}
\begin{groupplot}[
...
%  após o passa-baixas e após o equalizador.
% ============================================================================
\begin{frame}{Método Topo-Plano}{Representação Gráfica no Domínio da Frequência}
\centering
\begin{tikzpicture}
\begin{groupplot}[
  group style={group size=4 by 1, horizontal sep=0.85cm},
...
\nextgroupplot[title={(a) Espectro do pulso\\[1pt]{\tiny\ftstrut $|H(f)|/\tau$}},
  xmin=-\ftfmax, xmax=\ftfmax, ymin=0, ymax=1.3, xtick={-14,-7,0,7,14}, ytick={0,0.5,1},
...
\nextgroupplot[title={(a) Pulso centrado e causal\\[1pt]{\tiny\ftstrut $h_c(t)$ e $h(t)$}},
  xmin=-0.12, xmax=0.2, xtick={-0.1,0,0.1,0.2}]
